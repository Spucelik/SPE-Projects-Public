...
export const appConfig = {
  ...
  containerTypeId: "<ContainerType>", // Replace with your container type ID
  ...
  msalConfig: {
    auth: {
      clientId: "<ClientID>", // Same as above
      authority: "https://login.microsoftonline.com/<TenantID>", // Will be updated with actual tenant ID
